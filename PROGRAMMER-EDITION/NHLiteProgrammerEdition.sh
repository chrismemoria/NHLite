...
function print_banner() {
    ...
    printf "${blue}##    PROGRAMMER EDITION                        ##\n"
    printf "${blue}####  ############# NH PROGRAMMER EDITION ########${reset}\n\n"
}
...
printf "\n${blue}[*] Configurando NH Lite PROGRAMMER EDITION ...\n"
fix_profile_bash
fix_sudo
create_kex_launcher
fix_uid
...
nh -r curl -LO https://raw.githubusercontent.com/NuddleRat/NHLite/master/PROGRAMMER-EDITION/xstartup
nh -r cp xstartup /home/kali/.vnc/
nh -r mv xstartup /root/.vnc/
nh -r chmod +x /home/kali/.vnc/xstartup 
nh -r chmod +x /root/.vnc/xstartup

printf "\n${red}[*] Removendo recursos desnecessários do NH Lite PROGRAMMER EDITION ...${reset}\n "
...
printf "n${blue}[*] Instalando recursos para o NH PROGRAMMER EDITION ...${reset}\n"
nh -r sudo apt install jedit kate anjuta geany bluefish gedit bluefish-plugins codeblocks codelite vim-gtk vim-gtk3 vim emacs -y

espeak -v m1+pt_br "bem-vindo ao NetHunter Lite PROGRAMMER EDITION"
print_banner
printf "${green}[=] NH Lite PROGRAMMER EDITION v1.0 instalado com sucesso${reset}\n\n"
printf "${green}[+] Para iniciar o NH Lite PROGRAMMER EDITION v1.0, digite:${reset}\n"
...
printf "${green}[+] nethunter vncserver       # Para iniciar o NH Lite PROGRAMMER EDITION gui${reset}\n"
printf "${green}[+] nethunter vncserver -kill :1    # Para parar o NH Lite PROGRAMMER EDITION gui${reset}\n"
printf "${green}[+] nethunter -r          # Para executar o NH Lite PROGRAMMER EDITION como root${reset}\n"
printf "${green}[+] nh                    # Atalho para o NH Lite PROGRAMMER EDITION${reset}\n\n"
printf "${light_cyan}[!] NH PROGRAMMER EDITION É UMA EDIÇÃO DO NH LITE v1.0 VOLTADA PARA PROGRAMADORES, QUE ACOMPANHA A INTEFACE GRAFICA XFCE4 E PROGRAMAS PARA PROGRAMAÇÃO E IDE's, EDITORES DE TEXTO E, TUDO ISSO EM PORTUGUÊS.${reset}\n"
